...
venv=/usr/local/lib/python3.6/site-packages/virtualenv/fate
export JAVA_HOME=/software/git/FATE/env/jdk/jdk-8u192/
export PATH=$PATH:$JAVA_HOME/bin
source ${venv}/bin/activate
sed -i.bak "s#JAVA_HOME=/software/git/FATE/env/jdk/jdk-8u192/
